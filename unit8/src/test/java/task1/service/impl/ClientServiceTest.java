...
public class ClientServiceTest {
    ...
    public void whenUpdateExistClientThenReturnEntity() {
        ...
        ClientEntity newClient = clientService.update(clientRequest, client.getId());

        assertThat(newClient).isEqualToIgnoringGivenFields(clientRequest, IGNORING_FIELDS);
    ...
    public void whenUpdateNotExistingClientThenReturnEntity() {
        assertThrows(Exception.class,
                     () -> clientService.update(new ClientRequest(), UUID.randomUUID())
        );
    }
